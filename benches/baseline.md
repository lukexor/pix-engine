...
Frame timings for the SDL2 renderer, taken before the wgpu, egui and winit migration. These
measure how long a frame takes to render, so a rerun after each renderer phase says whether
batching arrived and whether anything regressed.
