...
impl From<SdlScancode> for Scan {
    fn from(scancode: SdlScancode) -> Self {
        match scancode {
            ...
            // SdlScancode::Exclaim => Self::Exclaim,
            // SdlScancode::Quotedbl => Self::Quotedbl,
            // SdlScancode::Hash => Self::Hash,
            // SdlScancode::Dollar => Self::Dollar,
            // SdlScancode::Percent => Self::Percent,
            // SdlScancode::Ampersand => Self::Ampersand,
            // SdlScancode::Quote => Self::Quote,
            // SdlScancode::LeftParen => Self::LeftParen,
            // SdlScancode::RightParen => Self::RightParen,
            // SdlScancode::Asterisk => Self::Asterisk,
            // SdlScancode::Plus => Self::Plus,
            ...
            // SdlScancode::Colon => Self::Colon,
            SdlScancode::Semicolon => Self::Semicolon,
            // SdlScancode::Less => Self::Less,
            // SdlScancode::Equals => Self::Equals,
            // SdlScancode::Greater => Self::Greater,
            // SdlScancode::Question => Self::Question,
            // SdlScancode::At => Self::At,
            SdlScancode::LeftBracket => Self::LeftBracket,
            SdlScancode::Backslash => Self::Backslash,
            SdlScancode::RightBracket => Self::RightBracket,
            // SdlScancode::Caret => Self::Caret,
            // SdlScancode::Underscore => Self::Underscore,
            // SdlScancode::Backquote => Self::Backquote,
            ...
            SdlScancode::NumLockClear => Self::NumLock,
